                ...
                ${this.props.customColumns
                    ...
                    for (const file of rows) {
                        ...
                        for (const col of this.props.customColumns) {
                            ...
                            if (this.props.useColumnFormatting &&
                                ((_d = columnFormattersByLibrary[lib.Id]) === null || _d === void 0 ? void 0 : _d[col.internalName])) {
                        ...
                        const extension = (_e = fileName.split(".").pop()) === null || _e === void 0 ? void 0 : _e.toLowerCase();
        ...
        const columns = [
            {
                ...
                onRender: (item) => {
                    var _a;
                    const extension = (_a = item.name.split(".").pop()) === null || _a === void 0 ? void 0 : _a.toLowerCase();
                    return (React.createElement(Stack, { horizontal: true, verticalAlign: "center" },
                        ...
                        React.createElement(Link, { href: item.editUrl, styles: {
                                root: {
                                    whiteSpace: "nowrap",
                                    overflow: "hidden",
